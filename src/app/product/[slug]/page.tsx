...
import { FullProduct } from "@/types/SProduct";
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="md:py-8">
                    ...
                    <div className="flex gap-3">
                        <AddtoBag currency="USD" description={data.description} image={data.images[0]}
                        price={data.price} key={data.id} name={data.name}
